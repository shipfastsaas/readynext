        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-text-primary dark:text-white">Product</h3>
                <ul role="list" className="mt-6 space-y-4">
                  {navigation.product.map((item) => (
                    <li key={item.name}>
                      <a
                        href={item.href}
                        className="text-sm leading-6 text-text-secondary hover:text-primary-light"
                      >
                        {item.name}
                      </a>
                    </li>
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm font-semibold text-text-primary dark:text-white">Support</h3>
                <ul role="list" className="mt-6 space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-text-primary dark:text-white">Legal</h3>
                <ul role="list" className="mt-6 space-y-4">
